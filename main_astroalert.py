...
try:
    ...
    print("Please ensure astrology_module.py is available")
    sys.exit(1)
    ...
    def detect_cyclones(self, image_path: str, conf_threshold: float = 0.01) -> Dict:
        ...
        try:
            ...
            if hasattr(results, 'xyxy') and len(results.xyxy) > 0:
                for i, detections in enumerate(results.xyxy):
...
def main():
    ...
    print("🌪 AstroAlert - Cyclone Prediction System")
    print("=" * 60)
    ...
    if len(sys.argv) > 1:
        ...
        print("Usage: python main_astroalert.py <image_path> [latitude] [longitude]")
        print("Example: python main_astroalert.py data/train/images/1.jpg 19.0760 72.8777")
